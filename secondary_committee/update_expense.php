...
if(isset($_POST["expense"]))
{
	...
	$sql="update sec_expense set amount='".$amount."',towards='".$towards."',exp_date='".$exp_date."',added_by='".$added_by."',last_updated='".$last_updated."',committee_year='".$cur_academic_year."' where id='".$id."'";
