...
if(isset($_POST["income"]))
{
	...
	$sql="update sec_income set amount='".$amount."',source='".$source."',rec_date='".$rec_date."',rec_no='".$rec_no."',added_by='".$added_by."',last_updated='".$last_updated."',committee_year='".$cur_academic_year."' where id='".$id."'";
