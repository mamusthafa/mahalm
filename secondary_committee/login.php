...
<div class="container" id="marks_card">
 <div class="row"><br><br><br>
	...
	<div class="col-sm-6" >
	 <div style="padding:10px;background-color:#3172c5;"><p style="color:#fff;text-align:center;font-size:30px;font-weight:bold;">Welcome to Swalath Committee </h1></div>
	...
	<input type="text" name="sec_uname" class="form-control">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
	  <label for="sel1"><span style="color:red;font-size:18px;">*</span>Committee Year:</label>
