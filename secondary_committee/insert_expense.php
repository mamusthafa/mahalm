...
if(isset($_POST["expense"]))
{
	...
	$sql="insert into sec_expense (amount,towards,exp_date,added_by,last_updated,committee_year) values('$amount','$towards','$exp_date','$added_by','$last_updated','$cur_academic_year')";
