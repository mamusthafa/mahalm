...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql="update student_fee set name='".$name."',parent_name='".$parent_name."',roll_no='".$roll_no."',academic_year='".$cur_academic_year."',class='".$class."',section='".$section."',tot_fee='".$tot_fee."',adm_fee='".$adm_fee."',tot_paid='".$tot_paid."',rec_date='".$rec_date."',rec_no='".$rec_no."' where id='".$id."'";

if ($conn->query($sql) === TRUE) {
	 $sql_upd="update students set tot_fee='".$tot_fee."' , tot_paid=tot_paid+'".$adm_fee."' where academic_year='".$cur_academic_year."' and first_name='".$name."' and roll_no='".$roll_no."'";
			  $conn->query($sql_upd);
