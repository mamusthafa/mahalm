...
$message_detail="Your Member Fee Balance is Rs.".$balance.". Please pay the fee as soon as possible ";


$sql="select parent_contact from members where first_name='".$first_name."' and member_id='".$member_id."'";	
...
header("Location:all_pending_fee.php?success=.'success'");
}
