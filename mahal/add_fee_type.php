...
<div class="container-fluid">
     ...
     <div class="panel-heading"><h4>Add Fee Type</h4></div>
...
<form action="insert_fee_type.php" method="post">
	...
	<input type="submit" name="fee_type" class="btn btn-success" value="Register">
	</form>
    </div>
    </div>
    </div>
