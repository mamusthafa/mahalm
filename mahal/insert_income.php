...
if(isset($_POST["income"]))
{
	...
	$sql="insert into income (amount,source,rec_date,rec_no,added_by,last_updated,committee_year) values('$amount','$source','$rec_date','$rec_no','$added_by','$last_updated','$cur_academic_year')";
