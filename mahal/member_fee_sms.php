...
$sql="select parent_contact,member_type from members where first_name='".$name."' and member_id='".$member_id."'";
...
if($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
	...
	////////////////////////////////////////////////////////////////////////////////////
	$sql_fee="select sum(fee_amount) as total_fee  from member_fee_type where member_type='".$member_type."' and committee_year='".$cur_committee_year."' and first_name='".$name."' and member_id='".$member_id."' ORDER BY id desc";
	var_dump($sql_fee);
