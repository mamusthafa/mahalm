...
$sql="select * from committee_name order by id desc";
...
<div class="row">
    ...
    <div class="col-sm-12">
	<a href="add_committee_name.php"><button type="button" class="btn btn-success">+ Add Committee Name</button></a>
	<h3>All Committee Names</h3>
	...
	<td>
		 <div class="btn-group">
        <a href="<?php echo 'edit_committee_name.php?id='.$row['id']; ?>" title="Edit">  <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
				...
				<script>
				  function deleteme(id){
					  if(confirm("Do you want to delete?")){
						  window.location.href='delete_committee_name.php?id='+id+'';
					  }
				  }
