...
?>
     ...
     <div class="panel-heading"><h4>Add Bank Withdrawals</h4></div>
...
<form action="insert_bank_withdraw.php" method="post">
	...
	<option value="">Select Bank</option>
	 ...
	 <div class="form-group">
	    <label for="usr">Withdraw Date:</label>
		<input type="date" name="withdraw_date" value="" class="form-control">
	  </div>
	 
	<input type="submit" name="bank_withdraw" class="btn btn-success" value="Submit Withdraw">
	</form><br>
