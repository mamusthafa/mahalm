...
<div class="container-fluid">
	...
	<h2 style="font-weight:bold;color:green;">Applications Received</h2>
	...
	$start_from = ($page-1) * $num_rec_per_page;
	 ...
	 $sql_cont="select * from applications  order by message_time desc  LIMIT $start_from, $num_rec_per_page";
	...
	?>
	 ...
	 <p style="text-align:right;color:black;background-color:yellow;border:1px solid #FFA07A;border-radius:50px 70px 0px 50px;padding-left:30px;padding-top:5px;padding-bottom:5px;padding-right:30px;"><span style="font-weight:bold;">Member : </span><a href="<?php echo 'print_application.php?id='.$message_id;?>"><?php echo $row["subject"];?> : <?php echo $row["message"];?> </a><span style="color:black;font-size:11px;">
	...
	$sql="select * from reply_applications where message_id='".$message_id."' order by message_time desc";
