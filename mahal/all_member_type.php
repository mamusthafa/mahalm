...
$sql="select * from member_type order by id desc";
...
<div class="row">
	...
	$committee_year=$row["committee_year"];
	 ...
	 ?>
	 <tr> 
	 <td><?php echo $member_type_name;?></td> 
	 <td><?php echo $committee_year;?></td> 
	 <td><?php echo $updated_date;?></td> 
	<td>
		 <div class="btn-group">
        <a href="<?php echo 'edit_member_type.php?id='.$row['id']; ?>" title="Edit">  <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
				...
				<script>
				  function deleteme(id){
					  if(confirm("Do you want to delete?")){
						  window.location.href='delete_member_type.php?id='+id+'';
					  }
				  }
